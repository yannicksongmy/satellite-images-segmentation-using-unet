...
## References
Demir, K. Koperski, D. Lindenbaum, G. Pang, J. Huang, S. Basu, F. Hughes, D. Tuia et R. Raskar, **[DeepGlobe 2018 : A Challenge to Parse the Earth Through Satellite Images](https://arxiv.org/abs/1805.06561)**, in _proceeding of The IEEE Conference on Computer Vision and Pattern Recognition (CVPR) Workshops_, 2018.

R. Olaf, F. Philipp et B. Thomas, **[U-Net: Convolutional Networks for Biomedical Image Segmentation](https://arxiv.org/abs/1505.04597)**, _arXiv_, 2015.
